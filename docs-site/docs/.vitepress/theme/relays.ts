...
export const RELAYS: Relay[] = [
  ...
  {
    id: "zzzcoding",
    aff: "https://api.zzzcoding.org",
    host: "api.zzzcoding.org",
    models: ["opus 5"],
    ...
    root: {
      ...
      rate: "1x 倍率",
      signup: "注册即得 $1000 额度",
      notes: ["只有 opus 5", "注册不定时开放，关闭期间注册不了"],
    },
    en: {
      name: "zzzcoding (public-benefit relay)",
      tested: "Tested working while registration was open.",
      rate: "1x rate",
      signup: "$1000 credit on signup",
      notes: [
        "Serves opus 5 only",
        "Registration only opens from time to time — you cannot sign up while it's closed",
      ],
    },
  },
];
