...
function PortalContent() {
  ...
  function passwordLogin(event: FormEvent) { event.preventDefault(); void action.run(() => client.passwordLogin(credentials.email.trim(), credentials.password), session => { if (session.user) { setExpired(false); setLoggedOut(false); boot.reload(); navigate("/"); } }); }
