...
const en = {
  ...
  "sessions.title": "Local agent sessions",
  "sessions.subtitle": "Search local transcripts, recover the right project directory, and copy resume commands.",
  "sessions.searchPlaceholder": "Search title, directory, command, or session id",
  "sessions.all": "All",
...
const zh = {
  ...
  "sessions.title": "本地智能体会话",
  "sessions.subtitle": "搜索本地会话记录，找到正确的项目目录，并复制恢复命令。",
  "sessions.searchPlaceholder": "搜索标题、目录、命令或会话 ID",
  "sessions.all": "全部",
  "sessions.grouped": "分组",
  "sessions.flat": "平铺",
