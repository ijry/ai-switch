...
const en = {
  ...
  "settings.webService.tailscaleEnabled": "Enable Tailscale",
  ...
  "settings.tailscale.subtitle": "Sign in for private remote access.",
  "settings.tailscale.refresh": "Refresh",
  "settings.tailscale.connected": "Connected",
  "settings.tailscale.notConnected": "Not connected",
  "settings.tailscale.disabled": "Tailscale access is disabled in web service settings.",
  "settings.tailscale.device": "Device: {value}",
  "settings.tailscale.ip": "IP: {value}",
  "settings.tailscale.login": "Login with Tailscale",
  "settings.tailscale.disconnect": "Disconnect",
  "settings.tailscale.loginError": "Could not start Tailscale login.",
...
const zh = {
  ...
  "settings.webService.tailscaleEnabled": "启用 Tailscale",
  ...
  "settings.tailscale.title": "Tailscale",
  "settings.tailscale.subtitle": "登录后可获得私有远程访问。",
  "settings.tailscale.refresh": "刷新",
  "settings.tailscale.connected": "已连接",
  "settings.tailscale.notConnected": "未连接",
  "settings.tailscale.disabled": "Web 服务设置中未启用 Tailscale 访问。",
  "settings.tailscale.device": "设备：{value}",
  "settings.tailscale.ip": "IP：{value}",
  "settings.tailscale.login": "使用 Tailscale 登录",
  "settings.tailscale.disconnect": "断开连接",
  "settings.tailscale.loginError": "无法启动 Tailscale 登录。",
