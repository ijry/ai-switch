...
const en = {
  ...
  "settings.feature.webService": "HTTP server and Tailscale access.",
  "settings.webService.title": "Web Service",
  "settings.webService.subtitle": "Serve the shared core over HTTP.",
  ...
  "settings.webService.start": "Start server",
  "settings.webService.stop": "Stop server",
  "settings.webService.refresh": "Refresh",
  "settings.webService.running": "Running at {url}",
  "settings.webService.stopped": "Server is stopped.",
...
const zh = {
  ...
  "settings.feature.webService": "HTTP 服务和 Tailscale 访问。",
  "settings.webService.title": "Web 服务",
  "settings.webService.subtitle": "通过 HTTP 提供共享核心。",
